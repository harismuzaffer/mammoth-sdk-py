...
class StripeWebhooks(BaseSDK):
    def handle(
        ...
        *,
    ...
    ) -> models.StripeWebhookResponseSchema:
        r"""Handle Stripe webhook
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.StripeWebhookResponseSchema, http_res)
