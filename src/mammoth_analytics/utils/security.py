...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("MAMMOTHANALYTICS_API_KEY"):
        security_dict["api_key"] = os.getenv("MAMMOTHANALYTICS_API_KEY")

    if os.getenv("MAMMOTHANALYTICS_API_SECRET"):
        security_dict["api_secret"] = os.getenv("MAMMOTHANALYTICS_API_SECRET")
