...
class AppUsage(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> models.AppUsageSchema:
        r"""Get app usage details
        ...
        :param fields: Fields to return. Can be (current_storage,max_storage_allowed)
        ...
        request = models.GetAppUsageRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/workspaces/{workspace_id}/app-usage",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.AppUsageSchema, http_res)
