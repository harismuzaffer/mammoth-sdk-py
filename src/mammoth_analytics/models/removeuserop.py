...
class RemoveUserRequestTypedDict(TypedDict):
    user_id: int
    r"""Id of the user"""
    workspace_id: int
...
RemoveUserExtraTypedDict = TypeAliasType(
    "RemoveUserExtraTypedDict", Union[Dict[str, Any], List[Any]]
)


RemoveUserExtra = TypeAliasType("RemoveUserExtra", Union[Dict[str, Any], List[Any]])
