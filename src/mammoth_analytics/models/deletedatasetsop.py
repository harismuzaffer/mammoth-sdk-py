...
class DeleteDatasetsRequestTypedDict(TypedDict):
    workspace_id: int
...
DeleteDatasetsExtraTypedDict = TypeAliasType(
    "DeleteDatasetsExtraTypedDict", Union[Dict[str, Any], List[Any]]
)


DeleteDatasetsExtra = TypeAliasType(
    "DeleteDatasetsExtra", Union[Dict[str, Any], List[Any]]
)
