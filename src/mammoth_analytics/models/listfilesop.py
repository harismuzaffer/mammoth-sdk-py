...
class ListFilesRequestTypedDict(TypedDict):
    ...
    r"""Track multiple file names, comma separated"""
    status: NotRequired[Nullable[str]]
    r"""Track multiple file statuses, comma separated"""
    created_at: NotRequired[Nullable[str]]
    r"""Track multiple files, which falls under created_at date range"""
    updated_at: NotRequired[Nullable[str]]
    r"""Track multiple files, which falls under updated_at date range"""
    ...
    r"""Sort the files based on the fields"""
