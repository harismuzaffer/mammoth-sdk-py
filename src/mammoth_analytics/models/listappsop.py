...
class ListAppsRequestTypedDict(TypedDict):
    workspace_id: int
    ...
    r"""Fields to return. Can be (id, app_name)"""
    sort: NotRequired[Nullable[str]]
    r"""Returned client apps based on this parameter Use the format '(field:asc)' for ascending and '(field:desc)' for descending order."""
