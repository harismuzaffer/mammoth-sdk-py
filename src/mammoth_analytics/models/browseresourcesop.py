...
class BrowseResourcesRequestTypedDict(TypedDict):
...
class BrowseResourcesRequest(BaseModel):
    fields: Annotated[
        Optional[str],
...
BrowseResourcesExtraTypedDict = TypeAliasType(
    "BrowseResourcesExtraTypedDict", Union[Dict[str, Any], List[Any]]
)


BrowseResourcesExtra = TypeAliasType(
    "BrowseResourcesExtra", Union[Dict[str, Any], List[Any]]
)


class BrowseResourcesResponseTypedDict(TypedDict):
    r"""Request fulfilled, document follows"""


class BrowseResourcesResponse(BaseModel):
    r"""Request fulfilled, document follows"""
