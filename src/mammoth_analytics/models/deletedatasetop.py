...
DeleteDatasetExtraTypedDict = TypeAliasType(
    "DeleteDatasetExtraTypedDict", Union[Dict[str, Any], List[Any]]
)


DeleteDatasetExtra = TypeAliasType(
    "DeleteDatasetExtra", Union[Dict[str, Any], List[Any]]
)
