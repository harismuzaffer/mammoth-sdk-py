...
class CloudDBBatchSourceTypedDict(TypedDict):
...
class CloudDBBatchSource(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["database", "host", "username"]
        nullable_fields = ["database", "host", "username"]
        null_default_fields = []
