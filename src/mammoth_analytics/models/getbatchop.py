...
GetBatchExtraTypedDict = TypeAliasType(
    "GetBatchExtraTypedDict", Union[Dict[str, Any], List[Any]]
)


GetBatchExtra = TypeAliasType("GetBatchExtra", Union[Dict[str, Any], List[Any]])
