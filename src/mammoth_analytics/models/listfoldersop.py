...
class ListFoldersRequestTypedDict(TypedDict):
    ...
    r"""Filter by multiple folder names, comma separated"""
    status: NotRequired[Nullable[str]]
    r"""Filter by multiple folder statuses, comma separated"""
    created_at: NotRequired[Nullable[str]]
    r"""Filter by multiple folders, which falls under created_at date range"""
    updated_at: NotRequired[Nullable[str]]
    r"""Filter by multiple folders, which falls under updated_at date range"""
    created_by: NotRequired[Nullable[str]]
    r"""Filter by multiple folder created by user names, comma separated"""
    ...
    r"""Sort the folders based on the fields"""
