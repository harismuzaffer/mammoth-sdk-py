...
class BrowseWorkspaceWorkspacesRequestTypedDict(TypedDict):
    workspace_id: int
...
class BrowseWorkspaceWorkspacesRequest(BaseModel):
...
BrowseWorkspaceWorkspacesExtraTypedDict = TypeAliasType(
    "BrowseWorkspaceWorkspacesExtraTypedDict", Union[Dict[str, Any], List[Any]]
)


BrowseWorkspaceWorkspacesExtra = TypeAliasType(
    "BrowseWorkspaceWorkspacesExtra", Union[Dict[str, Any], List[Any]]
)


class BrowseWorkspaceWorkspacesResponseTypedDict(TypedDict):
    r"""Request fulfilled, document follows"""


class BrowseWorkspaceWorkspacesResponse(BaseModel):
    r"""Request fulfilled, document follows"""
