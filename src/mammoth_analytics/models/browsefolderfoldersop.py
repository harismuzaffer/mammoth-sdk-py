...
class BrowseFolderFoldersRequestTypedDict(TypedDict):
    workspace_id: int
...
class BrowseFolderFoldersRequest(BaseModel):
...
BrowseFolderFoldersExtraTypedDict = TypeAliasType(
    "BrowseFolderFoldersExtraTypedDict", Union[Dict[str, Any], List[Any]]
)


BrowseFolderFoldersExtra = TypeAliasType(
    "BrowseFolderFoldersExtra", Union[Dict[str, Any], List[Any]]
)


class BrowseFolderFoldersResponseTypedDict(TypedDict):
    r"""Request fulfilled, document follows"""


class BrowseFolderFoldersResponse(BaseModel):
    r"""Request fulfilled, document follows"""
