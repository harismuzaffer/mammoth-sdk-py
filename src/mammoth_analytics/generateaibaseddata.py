...
class GenerateAiBasedData(BaseSDK):
    def get_validation_info(
        ...
        *,
        ...
        validate_only: OptionalNullable[bool] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GenAIValidationSpec:
        r"""Get validation information
        ...
        :param validate_only: Validate AI generation for the view
        ...
        request = models.GetValidationInfoRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="GetValidationInfo",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GenAIValidationSpec, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.GetValidationInfoBadRequestUnion, http_res
            )
            raise errors.GetValidationInfoBadRequest(response_data, http_res)
    ...
    async def get_validation_info_async(
        self,
        *,
        workspace_id: int = 2,
        project_id: int = 1,
