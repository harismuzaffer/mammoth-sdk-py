...
class Preferences(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> models.PreferencesSchema:
        r"""Fetch user preferences
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.PreferencesSchema, http_res)
    ...
    def update(
        ...
        *,
        patch: Union[
            List[models.PreferencesPatchOp], List[models.PreferencesPatchOpTypedDict]
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.PreferencesPatchRequest(
            patch=utils.get_pydantic_model(patch, List[models.PreferencesPatchOp]),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.PreferencesPatchRequest
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.UpdateUserPreferencesBadRequestUnion, http_res
            )
            raise errors.UpdateUserPreferencesBadRequest(response_data, http_res)
