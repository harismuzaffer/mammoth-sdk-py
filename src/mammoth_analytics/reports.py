...
class Reports(BaseSDK):
    def list(
        ...
        *,
        ...
        request = models.GetReportsRequest(
            limit=limit,
            offset=offset,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ReportList, http_res)
