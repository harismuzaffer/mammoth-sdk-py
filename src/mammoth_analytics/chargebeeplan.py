...
class ChargebeePlan(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> models.GetPlanSchema:
        r"""Get Chargebee plan
        ...
        request = models.GetChargebeePlanRequest(
            workspace_id=workspace_id,
        )

        req = self._build_request(
            method="GET",
            path="/workspaces/{workspace_id}/chargebee-plan",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetPlanSchema, http_res)
